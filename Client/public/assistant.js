(function () {
    ...
    const loadAssistant = async () => {
        try {
            const res = await fetch(`https://shifraai-rsu9.onrender.com/api/assistant/config/${userId}`)
      ...
      recognition.onresult = (e)=>{
        ...
        setTimeout( async () => {
            try {
                ...
                const res = await fetch("https://shifraai-rsu9.onrender.com/api/assistant/ask" , {
                    method:"POST",
                    headers:{
                        "Content-Type":
                      "application/json",
